...
Vec3<float> randomPoint(Cube cube){
    ...
    // float randx = cube.P.x + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(cube.size-cube.P.x)));
    // float randy = cube.P.y + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(cube.size-cube.P.y)));
    // float randz = cube.P.z + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(cube.size-cube.P.z)));
